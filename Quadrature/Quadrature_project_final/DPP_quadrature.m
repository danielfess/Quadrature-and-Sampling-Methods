...
%n-DPP vs. Monte carlo with appropriate weights
...
E = zeros(1000,200,2); %Errors for n-DPP and Kernel methods
toc %3 secs
...
legend('Kernel t=1',num2str(-coeff1(2)),'n-DPP',num2str(-coeff2(2)))
toc %+ 0.2 secs
savefig('DPPkernel2')